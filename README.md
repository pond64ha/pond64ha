...
-- GUI หลักที่เราจะเปิดหลังจากยืนยันรหัส (เปลี่ยนชื่อถ้าไม่ใช่ UESP1)
local mainGui = game.CoreGui:FindFirstChild("UESP1")
if mainGui then
    mainGui.Enabled = false
end

-- สร้าง GUI สำหรับรหัสผ่าน
local passwordGui = Instance.new("ScreenGui", PlayerGui)
...
-- รหัสผ่าน
local correctPassword = "9919"

button.MouseButton1Click:Connect(function()
    if input.Text == correctPassword then
        if mainGui then
        ...
        input.Text = ""
        input.PlaceholderText = "Incorrect password!"
